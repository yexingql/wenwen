console.log('%cCopyright © 2024 wenwen.net', 'background-color: #ff00ff; color: white; font-size: 24px; font-weight: bold; padding: 10px;');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var center = document.getElementById("PageLoading-wenwen-center");
    setTimeout(function () {
        checkProjectItems();
